...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: WaterDepthSelectionPage(),
    );
  }
}

class WaterDepthSelectionPage extends StatefulWidget {
    const WaterDepthSelectionPage({super.key});

  @override
  _DepthSelectionPageState createState() => _DepthSelectionPageState();
}

class _DepthSelectionPageState extends State<WaterDepthSelectionPage> {
